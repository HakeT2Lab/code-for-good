...
const About = () => {
  return (
    <Box sx={{
      bgcolor: '#fafafa', textAlign: 'center', fontFamily: 'Monospace'
    }}>
      ...
      <img src={Homelessness} className="Aboutimage" height="500px" width="1000px" />
      ...
      <br />
      <img src={Factors}className="Aboutimage" height="500px" width="1000px" />
      <Typography variant="subtitle1" >
        So, we created this page to connect people to organizations we researched in the fight against homelessness.
        Click the donation tab above to learn about these organizations.
      </Typography>
    </Box>
  )
};
